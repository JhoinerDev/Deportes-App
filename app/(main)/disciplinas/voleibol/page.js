...
const ScheduleCard = ({ day, time, location }) => (
    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-100">
        <div className="flex items-center space-x-3">
            <span className="bg-red-100 text-red-700 font-bold px-3 py-1 rounded text-xs uppercase">{day}</span>
...
export default function VoleibolPage() {
    ...
    // Clases específicas de color para Voleibol (Rojo/Coral)
    const primaryBg = "bg-red-600";
    const primaryAccent = "bg-red-100 text-red-700";

    return (
        <div className="bg-gray-50 min-h-screen pb-20">

            {/* ==================================================================
                SECCIÓN 1: HERO (Voleibol)
               ================================================================== */}
            <div className="relative h-[500px] w-full bg-slate-900 overflow-hidden rounded-b-[40px] shadow-2xl">
                ...
                {/* Aquí iría la foto real de Voleibol */}
                <div className="absolute inset-0 opacity-40 bg-[url('https://images.unsplash.com/photo-1596701198595-6d013af78c3b?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center"></div>

                <div className="relative z-20 h-full flex flex-col justify-center px-8 md:px-16 max-w-7xl mx-auto">
                    <span className="text-red-400 font-bold tracking-widest uppercase text-sm mb-2">
                        Disciplina de Coordinación
                    </span>
                    <h1 className="text-6xl md:text-8xl font-extrabold text-white tracking-tight italic">
                        VOLEIBOL<span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-pink-500">BOL</span>
                    </h1>
                    <p className="mt-4 text-gray-300 text-lg max-w-xl leading-relaxed">
                        Potencia de salto, bloqueo rápido y ataque certero. ¡Eleva tu juego a la red!
                    </p>
                    
                    <div className="mt-8 flex flex-wrap gap-4">
                        <button className={`${primaryBg} hover:bg-red-500 text-white font-bold py-4 px-8 rounded-full shadow-lg hover:shadow-red-500/50 transition transform hover:-translate-y-1`}>
                            INSCRIBIRME
                        </button>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-10 relative z-30">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            {activeTab === 'general' && (
                                <div className="space-y-6 animate-fadeIn">
                                    ...
                                    <p className="text-gray-600 leading-relaxed">
                                        El Voleibol requiere excelente coordinación motora, reflejos rápidos y comunicación constante. 
                                        Entrenamos la técnica de servicio, pase, remate y bloqueo, con énfasis en la lectura de juego.
                                    </p>
                                    
                                    <div className="bg-red-50 p-6 rounded-2xl border border-red-100">
                                        <h4 className="font-bold text-red-900 mb-2">Objetivos del Semestre</h4>
                                        <ul className="list-disc list-inside text-red-800 space-y-1">
                                            <li>Dominar el sistema de ataque 4-2.</li>
                                            <li>Mejorar el porcentaje de servicio efectivo.</li>
                                            <li>Asegurar el podio en la liga regional universitaria.</li>
                                        </ul>
                                    </div>
                                    ...
                                    <div className="flex items-center space-x-4 pt-4 border-t border-gray-100">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xl font-bold text-gray-900">Prof. Miguel Cárdenas</p>
                                            <p className="text-sm text-blue-600">mcardenas@unefa.edu.ve</p>
                                        </div>
                                    </div>
                                </div>
                            )}
                    ...
                    <div className="space-y-6">
                        ...
                        {/* Widget de Estado */}
                        <div className="bg-white rounded-3xl shadow-xl p-6 border-t-8 border-red-500">
                            ...
                            <div className="w-full bg-gray-200 rounded-full h-2.5 mt-2">
                                <div className="bg-red-500 h-2.5 rounded-full" style={{ width: '87.5%' }}></div>
                            </div>
                            <p className="mt-4 text-xs text-center text-red-500 font-bold">¡CUPOS A PUNTO DE CERRAR!</p>
                        </div>
